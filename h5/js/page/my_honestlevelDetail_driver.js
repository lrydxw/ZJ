...
$(document).ready(function(){
   	init();
	$('.gway_box').delegate('.goods_more','click',function(){
		window.location.href='tf_userInfo_goods.html?partyid='+_partyid+'&saoBz='+getParamVal('saoBz');
	})
 })
 function init(){
 	var param = {};
    param.url = apiUrl.getCreditAndTradeStatisticsByDriver+'&random=' + Math.random() + '&datasource=driverapp';
...
////					evaluateNum(50,20,'95'/1,'20.456248552'/1);
//      		}
//      	}
//  }
//  getJsonp(param);
